-- Migration: Add Terms & Conditions to Booking Confirmation Emails
-- Date: 2025-01-19
-- Description: Updates booking confirmation email templates to include terms_conditions variable

-- =====================================================
-- FRENCH TEMPLATE - Add Terms & Conditions Section
-- =====================================================
...
<body style="margin: 0; padding: 0; background-color: #1a1a2e; font-family: Segoe UI, Tahoma, Geneva, Verdana, sans-serif;">
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #1a1a2e;">
    ...
    available_variables = '["booking_reference", "booking_date", "booking_time", "participants", "booking_type", "branch_name", "branch_address", "branch_phone", "client_name", "client_first_name", "client_last_name", "client_email", "logo_activegames_url", "logo_lasercity_url", "current_year", "terms_conditions"]'::jsonb,
    updated_at = NOW()
WHERE code = 'booking_confirmation_fr';

-- =====================================================
-- ENGLISH TEMPLATE - Add Terms & Conditions Section
-- =====================================================
UPDATE email_templates
SET body_template = '<!DOCTYPE html>
<html lang="en">
...
-- =====================================================
-- HEBREW TEMPLATE - Add Terms & Conditions Section
-- =====================================================
UPDATE email_templates
SET body_template = '<!DOCTYPE html>
