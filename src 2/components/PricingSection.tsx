    ...
    <section id="pricing" className="py-10 md:py-16 min-h-[600px] w-full relative overflow-hidden" style={{
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-md mx-auto mb-16">
          <div className="bg-dark-100/90 backdrop-blur-sm rounded-2xl p-6 border border-secondary/30 hover:border-secondary/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.25)] text-center">
